...
public class Ex02 {
	public static void main(String[] args) {
		...
		/*
		 *     1) forEach() : peak() 메서드와 달리 ㅅ트림의 요소를 소모하면서 처리되는 최종 연산
...
//		int min = is4.reduce(Integer.MAX_VALUE, (a,b) -> a<b ? a:b);
